  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <main className="max-w-7xl mx-auto px-6 py-6 space-y-4">
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-4 grid grid-cols-1 md:grid-cols-5 gap-3">
          <select
            value={level}
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-auto">
          ...
          {!loading && logs.length === 0 && (
            <div className="px-4 py-10 text-center text-gray-400">Aucun log</div>
          )}
        </div>
      </main>
    </div>
